...
CommonUtil = com.ktds.targetatom.util.CommonUtils;
...
function getTime() {
	...
	var sTimestamp = currDateTime.getFullYear() + "-" + currDateTime.getMonth() + "-" + currDateTime.getDate() + " ";
	sTimestamp = currDateTime.getHours() + ":" + currDateTime.getMinutes() + ":" + currDateTime.getSeconds() + ":" + currDateTime.getMilliseconds();
