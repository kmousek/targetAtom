...
public class KRErrorCdr  extends ConmonCdr implements Serializable {
...
/*	@DataField(pos=52, length=0, trim=true, align="L", defaultValue="")
	...
	public String toString() {
		return "KRErrorCdr [sRecType=" + sRecType + ", sSourceFormat=" + sSourceFormat + ", sChrgId=" + sChrgId
...
/*	@DataField(pos=367, length=0, trim=true, align="L", defaultValue="")
	private char sMegapassId;*/
