...
public class INTKTErrorCdr extends ConmonCdr {
...
//	String sOldErrCd;
	...
	public INTKTErrorCdr() {
		super.setCdrType(CdrType.ERROR);
	}
	
	
	public INTKTErrorCdr(INTKTBody org) {
	...
	public String toString() {
		return "INTKTErrorCdr [sMzFileId=" + sMzFileId + ", sCdrSeq=" + sCdrSeq + ", sCallingNo=" + sCallingNo
