...
public class INTCCEnrichedCdr extends ConmonCdr { 
...
//	String sCallStartTime;	// 위에 기 선언 변수
	...
	public INTCCEnrichedCdr () {
		//log.debug("creating INTCCCommon");
...
//		log.debug("value={}", value);
	...
	public String toString() {
		return "INTCCEnrichedCdr [MAX_KTF_CTN_LENGTH = " + MAX_KTF_CTN_LENGTH + ", PCX_PAD_CHAR = " + PCX_PAD_CHAR + ", SMS_PAD_CHAR = " + SMS_PAD_CHAR + 
