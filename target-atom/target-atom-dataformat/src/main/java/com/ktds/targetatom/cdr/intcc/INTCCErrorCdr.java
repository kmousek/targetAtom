...
public class INTCCErrorCdr extends ConmonCdr {
...
//	String sOldErrCd;
	...
	public INTCCErrorCdr() {
		super.setCdrType(CdrType.ERROR);
	}
	
	
	public INTCCErrorCdr(INTCCBody org) {
	...
	public String toString() {
		return "INTCCErrorCdr [sMzFileId=" + sMzFileId + ", sCdrSeq=" + sCdrSeq + ", sCallingNo=" + sCallingNo
